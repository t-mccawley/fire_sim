...
class ConfigABC(ABC):
    ...
    def get_retirement_costs_inflation_adjusted(self,age:int,previous_year_market_return_rate:float) -> float:
    ...
    def get_social_security_annual_inflation_adjusted(self,age:int) -> float:
        ...
        time_period = age - SOCIAL_SECURITY_AGE
        return(inflation_adjustment(initial_amount,time_period))